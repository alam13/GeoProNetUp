...
parser.add_argument("--pdbbind_dir", help="dir to the pdbbind dataset output", type=str, default='data/medusadock_output')
parser.add_argument("--label_list_file", help="the path to label files", type=str, default='KTransPose_tmp')
...
parser.add_argument("--casf_groundtruth_dir", help="path to casf dataset GT", type=str, default='CASF-2016/coreset')
parser.add_argument("--casf_dir", help="path to casf dataset", type=str, default='CASF/s367')
...
def srand_data_load_save_coord2_thread(input_list, groundtruth_dir, pdbbind_dir, output_dir, resolution, bond_th, pocket_th, iteration, thread_num, thread_id):
    ...
    if not os.path.isdir(output_dir_tmp+'/test2'):
        os.makedirs(output_dir_tmp+'/test2')
...
def srand_data_load_save_coord2(input_list, groundtruth_dir, pdbbind_dir, output_dir, resolution, bond_th, pocket_th, iteration, thread_num = 1):
    ...
    if not os.path.isdir(output_dir+'/test2'):
        os.makedirs(output_dir+'/test2')
